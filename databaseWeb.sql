...
INSERT INTO `tbcustomers` (`customerID`, `customerAccount`, `customerPassword`, `customerName`, `customerPhone`) VALUES
(2, 'hahaha', '$2y$10$.3kw6AETIGleF4/ojyUs6.kJ6ic11t7Ramc6S8rw4xadqrPhMo6Le', 'Tuan Cu Nho', '0123456789');
...
(5, 'Canon 700D', 120, 'Phù hợp: Mọi người dùng, từ nghiệp dư tới có kinh nghiệm!! Giá cả hợp lý phải chăng!', 'Canon700D_1.jpg', 'canon700d-2.jpg', 1),
...
ALTER TABLE `tbcartdetail`
  ADD CONSTRAINT `fk_cartID` FOREIGN KEY (`cartID`) REFERENCES `tbcart` (`cartID`) ON DELETE CASCADE,
...
ALTER TABLE `tbproducts`
  ADD CONSTRAINT `fk_categoryID` FOREIGN KEY (`categoryID`) REFERENCES `tbcategories` (`categoryID`) ON DELETE CASCADE;
USE `phpmyadmin`;