                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a href="{{url('data-table')}}">Data Tables</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="{{url('deleteCustomer/'. $row->customerID)}}" class="btn btn-danger" onclick="return confirm('Are you sure to delete?');">Delete</a>
                                                    </td>
                                                </tr>
                                            @endforeach
