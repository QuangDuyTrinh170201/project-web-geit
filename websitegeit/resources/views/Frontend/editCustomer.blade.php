         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{url('updateCustomer')}}" method="POST">
                    ...
                    @csrf
                    <div class="md-3">
                        <label class="form-label" for="id"><h5 id ="txt-h2">Customer Name</h5></label>
                        <input type="text" name="name" class="form-control" placeholder="Enter your name" value="{{$data->customerName}}">
                    </div>
                    <div class="md-3">
