...
<body>
    ...
    <!-- ##### Welcome Area Start ##### -->
    <section class="welcome_area bg-img background-overlay" style="background-image: url({{url('public')}}/Frontend/img/bg-img/Banner1.png); ">
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url({{url('public')}}/Frontend/img/bg-img/producttechnology.jpg);">
                ...
                <!-- Single Catagory -->
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url({{url('public')}}/Frontend/img/bg-img/life.jpg);">
                        <div class="catagory-content">
                ...
                <!-- Single Catagory -->
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url({{url('public')}}/Frontend/img/bg-img/bg-4.jpg);">
                        <div class="catagory-content">
    ...
    <div class="cta-area">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="cta-content bg-img background-overlay" style="background-image: url({{url('public')}}/Frontend/img/bg-img/bg-5.jpg);">
